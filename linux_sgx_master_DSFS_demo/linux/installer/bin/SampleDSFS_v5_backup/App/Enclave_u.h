...
int32_t SGX_UBRIDGE(SGX_NOCONVENTION, u_sgxprotectedfs_fwrite_node_ecdsa, (void* f, uint64_t node_number, uint8_t* buffer, uint32_t node_size, uint8_t* p_signature));
int32_t SGX_UBRIDGE(SGX_NOCONVENTION, u_sgxprotectedfs_fread_node_ecdsa, (void* f, uint64_t node_number, uint8_t* buffer, uint32_t node_size, uint8_t* p_signature));
