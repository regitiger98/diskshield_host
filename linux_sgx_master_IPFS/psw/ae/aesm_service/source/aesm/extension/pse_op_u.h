...
#ifndef SQLITE_DB_INIT_HASH_TREE_TABLE_DEFINED__
#define SQLITE_DB_INIT_HASH_TREE_TABLE_DEFINED__
pse_op_error_t SGX_UBRIDGE(SGX_NOCONVENTION, sqlite_db_init_hash_tree_table, (void));
#endif
#ifndef SQLITE_READ_DB_DEFINED__
#define SQLITE_READ_DB_DEFINED__
pse_op_error_t SGX_UBRIDGE(SGX_NOCONVENTION, sqlite_read_db, (uint32_t leaf_id, pse_vmc_hash_tree_cache_t* cache));
#endif
#ifndef SQLITE_WRITE_DB_DEFINED__
#define SQLITE_WRITE_DB_DEFINED__
...
#endif
#ifndef SQLITE_READ_CHILDREN_OF_ROOT_DEFINED__
#define SQLITE_READ_CHILDREN_OF_ROOT_DEFINED__
pse_op_error_t SGX_UBRIDGE(SGX_NOCONVENTION, sqlite_read_children_of_root, (pse_vmc_children_of_root_t* children));
#endif
#ifndef SQLITE_GET_EMPTY_LEAFNODE_DEFINED__
#define SQLITE_GET_EMPTY_LEAFNODE_DEFINED__
pse_op_error_t SGX_UBRIDGE(SGX_NOCONVENTION, sqlite_get_empty_leafnode, (int* leaf_node_id, sgx_measurement_t* mr_signer));
#endif
#ifndef PSDA_INVOKE_SERVICE_OCALL_DEFINED__
#define PSDA_INVOKE_SERVICE_OCALL_DEFINED__
...
#endif
#ifndef SQLITE_ROLLBACK_DB_FILE_DEFINED__
#define SQLITE_ROLLBACK_DB_FILE_DEFINED__
pse_op_error_t SGX_UBRIDGE(SGX_NOCONVENTION, sqlite_rollback_db_file, (void));
#endif
